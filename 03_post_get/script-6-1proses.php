...
<body>
    ...
    <?php
        $namaAnda = $_POST['Naya']; // membaca input dari komponen nama
        $alamatAnda = $_POST['Jl subulussalam']; // membaca input dari komponen alamat
        ...
        echo "<table>";
        echo "<tr><td>Nama Anda</td><td>:</td><td>".$Naya."</td></tr>";
        echo "<tr><td>Alamat Anda</td><td>:</td><td>".$jl subulussalam."</td></tr>";
